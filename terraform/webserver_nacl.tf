...
variable "blocked_cidrs" {
  ...
  default = [
    ...
    "91.92.246.0/24", "91.92.252.0/24","103.109.244.0/24", "4.178.106.0/24", "94.156.64.0/24",
    "159.203.16.0/24", "160.20.164.0/23", "45.62.160.0/20", "185.147.62.0/23", "104.16.0.0/12"]
}
